...
function initGame() {
    ...
    class Enemy {
        constructor(x, y, platforms, player) {
            this.x = x;
            this.y = y;
            this.vy = 0;
            this.width = 50;
    ...
    function spawnEnemy(x, y) {
        // You should have a player instance defined somewhere for the game. 
        // We're assuming it's a global object for now.
        const newEnemy = new Enemy(x * 50, y * 50, platforms, player);
        return newEnemy;
    }
